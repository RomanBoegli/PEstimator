...
import base.app.AppController;
import base.app.AppModel;
import base.app.AppView;
import base.splash.SplashController;
import base.splash.SplashModel;
import base.splash.SplashView;
...
public class PEstimator extends Application {
    
	private static PEstimator mainProgram; // singleton
    ...
    protected static PEstimator getMainProgram() {
